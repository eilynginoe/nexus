document.addEventListener('DOMContentLoaded', () => {
    ...
    document.querySelector('.categoria-uno').addEventListener('click', () => filterSlides('categoria 1'));
    document.querySelector('.categoria-dos').addEventListener('click', () => filterSlides('categoria 2'));
    document.querySelector('.categoria-tres').addEventListener('click', () => filterSlides('categoria 3'));
